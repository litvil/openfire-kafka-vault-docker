...
This is debuggable version of https://github.com/gizmotronic/docker-openfire Docker Image
...
- To remote debug just create connection to localhost:8000
(or other port specified in docker-composer.yml)
...
```bash
docker build -t ruby/openfire:4.2.3 .
```
